...
inline bool inRange(const T& value, const Range<T>& range, enum class RangeBoundaries includeRangeBoundaries)
{
...
// boundaries can be included or excluded; by default, only minimum boundary is included
inline bool inRange(const T& value, const T& min, const T& max, enum class RangeBoundaries includeRangeBoundaries)
{
...
bool inAreaRange(const Vector2<T>& point, const AreaRange<T>& areaRange, enum class AreaRangeBoundaries includeAreaRangeBoundaries)
{
